...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        float efficiency = (message.length()*8)/(float)codedString.length() - 1;

        System.out.println();
        System.out.println("The coded string is " + codedString);
        System.out.println("The Length of coded string is  " + codedString.length());
        System.out.println("The Length of original string is  " + message.length()*8);
        System.out.println("The compression efficiency is " + efficiency);
    ...
    private static int inorderArray(Node root, ArrayList<String> array, int index) {
        if (root == null) {
            return index;
        }
        index = inorderArray(root.left, array, index);
        array.add(index++, root.value);
